...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      // Prefer a single dedicated deployer key if provided; otherwise fall back to mnemonic
      ...
      chainId: 11155111,
      // Use explicit SEPOLIA_RPC_URL when provided, otherwise fall back to Infura project id
